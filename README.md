...
### 📋 Sobre Mim
Estudante de **Técnico em Cibersistemas para Automação**, busco unir minha experiência sólida em **Elétrica Industrial** com o desenvolvimento de software robusto e escalável. Sou apaixonado por resolver problemas complexos na interseção entre o hardware e o digital.

- 🎓 **Graduações:** Eletricista Industrial pelo **SENAI**.
- 🚀 **Atualmente:** Focado em segurança e conectividade para sistemas de automação.
...
| **Protocolos/Outros** | MQTT, WebSockets, PostgreSQL |
...
* 💼 **LinkedIn:** [Acesse meu perfil aqui](https://www.linkedin.com/in/mateusdosscavalheiro/)
* 🖥️ **Portfólio:** [Veja meu site pessoal](https://mateusdossantoscavalheiro-sudo.github.io/Portifolio/)
